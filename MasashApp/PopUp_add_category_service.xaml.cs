...
public partial class PopUp_add_category_service : ContentPage
{
	public PopUp_add_category_service()
	{
		InitializeComponent();
        Loaded += Page_Loaded;
	}
    ...
    public async void Add_category(object sender, TappedEventArgs e)
    {
        ...
        await StaticData.API.POST("/add_category_service", new Dictionary<string, string>()
        {
